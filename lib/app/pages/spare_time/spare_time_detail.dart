...
class SpareTimeDetail extends StatelessWidget {
  SpareTimeDetail({super.key});
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
          children: <Widget>[
            ...
            MaterialButton(
              ...
              onPressed: () {
                if (spareTimeC.endDate.value!.isBefore(spareTimeC.startDate.value!)) {
